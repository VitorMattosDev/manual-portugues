# ROADMAP — Manual de Língua Portuguesa

Fila executável autoritativa. **Um capítulo por sessão.** Consulte esta tabela para
saber o próximo capítulo (primeiro ⬜ de cima para baixo, respeitando a ordem dos
volumes — estratégia de fatia vertical) e atualize o status (⬜ → ✅ + data) ao concluir.
...
| 59 | Aspas, travessão, parênteses e reticências | `capitulos/cap-59-aspas-travessao-parenteses.qmd` | 9 | ⬜ |
| 60 | Pontuação no período composto e em textos reais | `capitulos/cap-60-pontuacao-periodo-composto.qmd` | 9 | ⬜ |
...
- **Fase 1 — Fundamentos da Língua** (Vol. 1–5, caps. 01–35)
- **Fase 2 — Sintaxe e Sentido** (Vol. 6–10, caps. 36–67)
- **Fase 3 — Texto, Variação e Usos** (Vol. 11–15, caps. 68–98)

Concluir uma fase inteira antes de abrir a próxima; dentro da fase, concluir um
volume inteiro antes de abrir o próximo.
